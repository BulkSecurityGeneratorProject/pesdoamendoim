package com.pesdoamendoim.competition.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.pesdoamendoim.competition.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.pesdoamendoim.competition.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
